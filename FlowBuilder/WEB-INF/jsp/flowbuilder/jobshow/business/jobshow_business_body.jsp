...
<BODY BGCOLOR="#FFFFFF" LEFTMARGIN="0" TOPMARGIN="0" MARGINWIDTH="0" MARGINHEIGHT="0">
	...
	<table width="60%" border="0" cellspacing="0" cellpadding="0">
		<tr> 
			<td></td>
			<td width="400" align="left" valign="middle" nowrap><img src="/FlowBuilder/images/businessTrip.gif"></img></td>
		...
		<tr bgcolor="#FFFFFF"> 
			<td height=30 align="right">
				<table bgcolor="#999999" align=center border=0 cellpadding=1 cellspacing=1 width="740">
					...
					<tr align="left" bgcolor="#ffffff" valign="middle">
						<td height=25 width=150  nowrap>出張期間</td>
						<td height=25 width=400 >
						<!--COMBOX選択部品-->
